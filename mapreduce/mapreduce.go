...
func MapName(fileName string, MapJob int) string {
	return "/Users/seanli/Documents/data/distributed/mrtmp." + fileName + "-" + strconv.Itoa(MapJob)
}
...
func MergeName(fileName string, ReduceJob int) string {
	return "/Users/seanli/Documents/data/distributed/mrtmp." + fileName + "-res-" + strconv.Itoa(ReduceJob)
}
...
func (mr *MapReduce) Merge() {
	...
	file, err := os.Create("/Users/seanli/Documents/data/distributed/mrtmp." + mr.file)
	if err != nil {
...
func (mr *MapReduce) CleanupFiles() {
	...
	RemoveFile("/Users/seanli/Documents/data/distributed/mrtmp." + mr.file)
}
